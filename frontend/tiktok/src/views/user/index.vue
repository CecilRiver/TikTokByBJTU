<template>
    <v-container :fluid="true" style="height: 500px;">
        <v-card>
            <v-img :height="220" aspect-ratio="16/9" cover src="https://www.wmkj.com.cn/upload/wz2014/image/1699/HXJQXMWVKR/20210410/1618025396125470.jpg">
                <v-list
            ...
            <v-row>
                <v-col cols="3">
                    <v-tabs v-model="tab" color="#7bbfea" vertical>
...
const getUserInfo = () => {
    console.log(111)
    console.log(userStore.$state.info.id)
